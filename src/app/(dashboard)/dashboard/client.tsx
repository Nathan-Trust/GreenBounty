...
const DashboardClient = () => {
  ...
  return (
    <div className="grid grid-cols-12 p-6 gap-6">
      {/* top card banner */}
      <Card className="col-span-12 bg-[#548235] text-white ">
      ...
      <Card className="col-span-12 lg:col-span-5 border bg-white border-[#548235]  ">
        <CardContent className="flex gap-4 items-start p-4">
          ...
          <div>
            <p>Eco-coin balance</p>
            <p className="text-xl font-medium">${userData?.wallet}</p>
          </div>
        </CardContent>
      </Card>
      <Card
        className="col-span-12 lg:col-span-5 border border-[#548235] "
        style={{
          backgroundImage:
