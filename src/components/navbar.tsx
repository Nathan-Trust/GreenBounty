...
const Navbar = () => {
  const { setIsSidebarOpen, user, active } = useProviderContext();

  return (
    <div className="border-b-2 border-[#00000080] h-14 w-full  z-20 bg-white flex items-center justify-between px-5">
      <p>{active}</p>
