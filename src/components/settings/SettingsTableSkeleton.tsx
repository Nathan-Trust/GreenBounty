...
interface SettingsTableSkeletonProps {
  length: number;
  children?: React.ReactNode;
}

export const SettingsTableSkeleton: React.FC<SettingsTableSkeletonProps> = ({
  length,
  children,
}) => {
  const renderTableHeaders = settingsTableHeaders.map((header) => (
