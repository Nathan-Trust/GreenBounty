...
interface UserIdTableSkeletonProps {
  length: number;
  children?: React.ReactNode;
}

export const UserIdTableSkeleton: React.FC<UserIdTableSkeletonProps> = ({
  length,
  children,
}) => {
  const renderTableHeaders = userIdTableHeader.map((header) => (
